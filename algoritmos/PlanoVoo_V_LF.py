...
"""
/***************************************************************************
 Flight Planner - Vertical Flight Linear Facade
                                 A QGIS plugin
 Flight Planner VLF
...
class PlanoVoo_V_LF(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if dist_ponto_base < 3:
            raise QgsProcessingException(f"❌ Horizontal distance ({round(dist_ponto_base, 2)}) cannot be less than 3 meters.")
        ...
        if arquivo_csv and arquivo_csv.endswith('.csv'): # Verificar se o caminho CSV está preenchido
            gerar_CSV("VLF", pontos_reproj, arquivo_csv, velocidade, tempo, deltaFront, angulo_perpendicular, H, gimbalAng, terrain)
    ...
    def name(self):
        return 'Flight_Plan_V_LF'

    def displayName(self):
        return self.tr('1. Linear Facade')
