...
class PlanoVoo_H_Line(QgsProcessingAlgorithm):
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterVectorLayer('linha', 'Axis Line', types=[QgsProcessing.TypeVectorPolygon]))
        ...
        self.addParameter(QgsProcessingParameterNumber('bf','Buffer (m)',
    ...
    def displayName(self):
        return self.tr('2.Following terrain - Line')
