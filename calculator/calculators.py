...
class Calculator_Dialog(QDialog):
    def __init__(self, iface):
        ...
        self.spacingForward.setRange(1, 150)
        self.spacingSide = QDoubleSpinBox()
        self.spacingSide.setRange(1, 250)
        ...
        overlap_form.addRow("Forward Photo Spacing (1 to 150 m):", self.spacingForward)
        overlap_form.addRow("Side Line Spacing (1 to 250 m):", self.spacingSide)
